...
ALTER TABLE centro_dep ADD CONSTRAINT centro_deportivo_pk PRIMARY KEY ( id_centro );
...
CREATE TABLE contrato_app (
    id_contrato_app        NUMBER(7) NOT NULL,
    fecha_inicio_contrato  DATE NOT NULL,
    fecha_termino_contrato DATE NOT NULL,
    estado_contrato        VARCHAR2(30) NOT NULL,
    tipo_contrato          VARCHAR2(100) NOT NULL,
    id_centro              NUMBER(6),
    centro_dep_id_centro   NUMBER(6) NOT NULL
);

CREATE UNIQUE INDEX contrato_app__idx ON
    contrato_app (
        centro_dep_id_centro
    ASC );

ALTER TABLE contrato_app ADD CONSTRAINT contrato_app_pk PRIMARY KEY ( id_contrato_app );
...
ALTER TABLE contrato_cli ADD CONSTRAINT contrato_pk PRIMARY KEY ( id_contrato );
...
ALTER TABLE emplea ADD CONSTRAINT emplea_pk PRIMARY KEY ( preparador_fisico_rut_prep,
...
CREATE TABLE met_pago_emp (
    id_met_pago_emp      NUMBER(7) NOT NULL,
    nombre_met_pago      VARCHAR2(50) NOT NULL,
    des_met_pago_emp     VARCHAR2(100) NOT NULL,
    centro_dep_id_centro NUMBER(6) NOT NULL
);

ALTER TABLE met_pago_emp ADD CONSTRAINT met_pago_emp_pk PRIMARY KEY ( id_met_pago_emp );
...
ALTER TABLE metodo_pago_cli ADD CONSTRAINT metodo_pago_pk PRIMARY KEY ( id_metodo_pago );
...
CREATE TABLE pago_app (
    id_pago_app                  NUMBER(7) NOT NULL,
    monto_pago                   NUMBER(6) NOT NULL,
    fecha_pago                   DATE NOT NULL,
    estado_pago                  VARCHAR2(30) NOT NULL,
    contrato_app_id_contrato_app NUMBER(7) NOT NULL,
    met_pago_emp_id_met_pago_emp NUMBER(7) NOT NULL
);

ALTER TABLE pago_app ADD CONSTRAINT pago_app_pk PRIMARY KEY ( id_pago_app );
...
ALTER TABLE contrato_app
    ADD CONSTRAINT contrato_app_centro_dep_fk FOREIGN KEY ( centro_dep_id_centro )
        REFERENCES centro_dep ( id_centro );

ALTER TABLE contrato_cli
    ADD CONSTRAINT contrato_cli_plan_fk FOREIGN KEY ( plan_id_plan )
        REFERENCES plan ( id_plan );
...
ALTER TABLE emplea
    ADD CONSTRAINT emplea_centro_deportivo_fk FOREIGN KEY ( centro_deportivo_id_centro )
        REFERENCES centro_dep ( id_centro );

ALTER TABLE emplea
    ADD CONSTRAINT emplea_preparador_fisico_fk FOREIGN KEY ( preparador_fisico_rut_prep )
        REFERENCES preparador_fisico ( rut_prep );
...
ALTER TABLE met_pago_emp
    ADD CONSTRAINT met_pago_emp_centro_dep_fk FOREIGN KEY ( centro_dep_id_centro )
        REFERENCES centro_dep ( id_centro );
...
ALTER TABLE pago_app
    ADD CONSTRAINT pago_app_contrato_app_fk FOREIGN KEY ( contrato_app_id_contrato_app )
        REFERENCES contrato_app ( id_contrato_app );

ALTER TABLE pago_app
    ADD CONSTRAINT pago_app_met_pago_emp_fk FOREIGN KEY ( met_pago_emp_id_met_pago_emp )
        REFERENCES met_pago_emp ( id_met_pago_emp );

ALTER TABLE pago
    ADD CONSTRAINT pago_contrato_cli_fk FOREIGN KEY ( contrato_cli_id_contrato )
        REFERENCES contrato_cli ( id_contrato );

ALTER TABLE pago
    ADD CONSTRAINT pago_metodo_pago_cli_fk FOREIGN KEY ( metodo_pago_cli_id_metodo_pago )
        REFERENCES metodo_pago_cli ( id_metodo_pago );
